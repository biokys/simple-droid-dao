...
public class CreateTableSqlBuilder {
    ...
    public CreateTableSqlBuilder addTextColumn(String name, boolean notnull) {
        ...
        this.sql += createColumn(DATA_TYPE_TEXT, name, notnull);
        return this;
    }
    ...
    public CreateTableSqlBuilder addRealColumn(String name, boolean notnull) {
        ...
        this.sql += createColumn(DATA_TYPE_REAL, name, notnull);
        return this;
    }
    ...
    public CreateTableSqlBuilder addIntegerColumn(String name, boolean notnull) {
        ...
        this.sql += createColumn(DATA_TYPE_INTEGER, name, notnull);
        return this;
    }
    ...
    public CreateTableSqlBuilder addBlobColumn(String name, boolean notnull) {
        ...
        this.sql += createColumn(DATA_TYPE_BLOB, name, notnull);
        return this;
    }
    ...
    private String createColumn(String dataType, String name, boolean notNull) {
